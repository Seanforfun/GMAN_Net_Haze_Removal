#  ====================================================
#   Filename: distribute_uitls.py
#   Original:cifar10_utils.py:https://github.com/tensorflow/models/blob/master/tutorials/image/cifar10_estimator/cifar10_utils.py
