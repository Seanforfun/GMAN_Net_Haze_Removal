...
class GMEAN(Model):
    ...
    def inference(self, input_data):
        ...
        # ####################Convolutional Model###########################
        # ################################################################
        x_s = tools.conv('DN_conv1_1', input_data, 3, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tools.conv('DN_conv1_2', x_s, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        ...
        x1 = tools.conv('DN_conv1_3', x, 128, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tools.conv('DN_conv2_1', x1, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tools.conv_nonacti('DN_conv2_2', x, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tf.add(x, x1)
        # x = tools.batch_norm(x)
        x = tools.acti_layer(x)

        # x = tools.conv('DN_conv2_3', x, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tools.conv('DN_conv2_4', x, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        ...
        x = tools.conv('DN_conv3_5', x, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        ...
        x = tools.conv_nonacti('DN_conv4_4', x, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tf.add(x, x3)
        # x = tools.batch_norm(x)
        x = tools.acti_layer(x)

        x = tools.conv('DN_conv4_5', x, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        ...
        x = tools.conv('DN_conv6_6', x, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tools.conv_nonacti('DN_conv6_7', x, 64, 64, kernel_size=[3, 3], stride=[1, 1, 1, 1])
        x = tf.add(x, x_s)
        # # x = tools.batch_norm(x)
        x = tools.acti_layer(x)

        x = tools.conv('DN_conv6_8', x, 64, 3, kernel_size=[3, 3], stride=[1, 1, 1, 1])
